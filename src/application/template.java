...
/**
 * template - A template for other classes. This template contains all information required to create a new class
 * and divide it into to sections accordingly.
 * <p>
 * This is used by simply copying the contents of this class and pasting into a new one. You must be sure to
 * update the contents however to be relevant before adding anything else.
 * 
 * @author zah2
